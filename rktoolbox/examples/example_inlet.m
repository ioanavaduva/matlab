...
% Here is a list of other numerical illustrations of parallelization 
% strategies: 
%
% <example_parallel.html Overview of the parallelization options>
%
% RKT_SMALLBREAK
%
% <example_nearopt.html Numerical illustration from [2, Sec. 3.4]>
%
% RKT_SMALLBREAK
%
% <example_tem.html TEM example from [2, Sec. 5.1]>
%
% RKT_SMALLBREAK
%
% <example_waveguide.html Waveguide example from [2, Sec. 5.3]>
