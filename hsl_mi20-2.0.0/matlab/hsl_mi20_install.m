function hsl_mi20_install(varargin)
%
%   hsl_mi20_install installs hsl_mi20.
%
%   VARARGIN
%
...
if(g95_fix)
   ...
   % common90.g95.f90 and ddeps90.g95.f90 contain alternate versions of
   % hsl_zb01 that work around this bug (in a manner that is not sadly
   % not compatible with other compilers!)
   ...
   do_unix_cmd('rm ddeps90.f90');
else
   mexcompile(MEXFLAGS, '-c', [srcdir,'/common90.f90'], '')
   mexcompile(MEXFLAGS, '-c', [srcdir,'/ddeps90.f90'], '')
end
mexcompile(MEXFLAGS, '-c', [srcdir,'/hsl_mi20d.f90'], '')
mexcompile(MEXFLAGS, '-c', 'hsl_matlab.F90', '')
mexcompile(MEXFLAGS, '-output hsl_mi20', 'hsl_mi20.f90 hsl_matlab.o hsl_mi20d.o ddeps90.o common90.o ddeps.o', LIBS)
